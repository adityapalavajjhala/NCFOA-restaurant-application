...
public class AddEmployeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = (Spinner) findViewById(R.id.DropDownMenu);
        email = (EditText) findViewById(R.id.AddEmployeeEmail);
        password = (EditText) findViewById(R.id.AddEmployeePassword);
        specialty = (EditText) findViewById(R.id.AddSpeciality300);
        salary = (EditText) findViewById(R.id.AddEmployeeSalary);
        special = (TextView) findViewById(R.id.specialityLabel300);
        addButton = (Button) findViewById(R.id.AddNewEmployeeButton);
